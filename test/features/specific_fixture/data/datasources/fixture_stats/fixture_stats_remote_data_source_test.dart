...
import 'package:live_football/features/specific_fixture/data/datasources/impl/fixture_stats/fixture_stats_remote_data_source.dart';
...
void main() {
  ...
  group('getStats', () {
    ...
    test(
      ...
      //act
      final call = dataSource.getFixtureComponent(tFixtureId);
      //assert
